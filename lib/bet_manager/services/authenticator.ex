defmodule BetManager.Services.Authenticator do
  @seed "user token"
  @secret "CHANGE_ME_NdjsndkankdnakDNKASDnsakjdnk3"
  ...
  defp get_token_from_header(auth_header) do
    {:ok, req} = Regex.compile("Bearer\:?\s+(.*)$", "i")
    case Regex.run(req, auth_header) do
